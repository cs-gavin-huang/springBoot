...
public class MySqlBackupRestoreUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String password = "999617";
        String database = "sys_manager";

        System.out.println("开始备份");
        String backupFolderPath = "/Users/code/Desktop/mango/backup/*";
        String fileName = "mango.sql";
        backup(host, userName, password, backupFolderPath, fileName, database);
        System.out.println("备份成功");

        System.out.println("开始还原");
        String restoreFilePath = "/Users/code/Desktop/mango/backup/mango.sql";
