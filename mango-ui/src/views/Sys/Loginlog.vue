 ...
 * @LastEditTime: 2021-01-12 19:55:47
 * @LastEditors: your name
 * @Description:
 * @FilePath: /springBoot/mango-ui/src/views/Sys/Loginlog.vue
-->
<template>
  <div class="page-container">
	...
	<div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
		<el-form :inline="true" :model="filters" :size="size">
			...
			<el-form-item>
				<sysm-button icon="fa fa-search" :label="$t('action.search')" perms="sys:loginlog:view" type="primary" @click="findPage(null)"/>
			</el-form-item>
		</el-form>
	</div>
	<!--表格内容栏-->
