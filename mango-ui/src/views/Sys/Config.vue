  ...
  <div class="page-container">
	...
	<div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
		<el-form :inline="true" :model="filters" :size="size">
			...
			<el-form-item>
				<sysm-button icon="fa fa-search" :label="$t('action.search')" perms="sys:config:view" type="primary" @click="findPage(null)"/>
			</el-form-item>
			<el-form-item>
				<sysm-button icon="fa fa-plus" :label="$t('action.add')" perms="sys:config:add" type="primary" @click="handleAdd" />
			</el-form-item>
		</el-form>
	</div>
	<!--表格内容栏-->
	<sysm-table permsEdit="sys:config:edit" permsDelete="sys:config:delete"
